...
| [no-wildcard-imports](https://github.com/readmeio/standards/tree/main/packages/eslint-plugin/docs/rules/no-wildcard-imports.md)                                 | Ban wildcard imports (`import * as something`) from libraries.                      | 📁 ⚛️ |     |     |
